...
<?php
$addlog = "SELECT book.BookTitle, editrecord.actionType, editrecord.time FROM editrecord INNER JOIN book ON editrecord.bookID = book.BookID WHERE actionType = 'addbook' ORDER BY time DESC";
